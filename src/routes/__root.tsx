...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Análise e geração de anúncios profissionais para Mercado Livre, Shopee, Amazon e OLX com IA." },
      { name: "twitter:description", content: "Análise e geração de anúncios profissionais para Mercado Livre, Shopee, Amazon e OLX com IA." },
